...
use App\Http\Repositories\Utils\Convert_slug_name;
use App\Models\Professions;
use App\Models\Service;
use App\Models\User;
use Illuminate\Database\Seeder;
use Illuminate\Support\Facades\DB;
use \App\Console\Commands\SetCurrentCrudboosterState;
...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Cms_usersSeeder::run();
        $this->command->info('Cms_usersSeeder completed');
        Cms_modulsSeeder::run();
        $this->command->info('Cms_modulsSeeder completed');
        Cms_privilegesSeeder::run();
        $this->command->info('Cms_privilegesSeeder completed');
        Cms_privileges_rolesSeeder::run();
        $this->command->info('Cms_privileges_rolesSeeder completed');
        Cms_settingsSeeder::run();
        $this->command->info('Cms_settingsSeeder completed');
        CmsEmailTemplates::run();
        $this->command->info('CmsEmailTemplates completed');
        SetCurrentCrudboosterState::startCommand( $this->command );
        $this->command->info('SetCurrentCrudboosterState completed');


        // if (User::query()->where('email', 'vbarrera@outlook.com')->get()->isEmpty()) {
